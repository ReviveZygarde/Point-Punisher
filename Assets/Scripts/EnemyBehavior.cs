...
void Start()
    ...
    */
    ...
    void reEnableCollision(Collision collision)
    {
       Physics.IgnoreCollision(collision.gameObject.GetComponent<Collider>(), this.GetComponent<Collider>(), false);
    }
